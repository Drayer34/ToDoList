...
public class DisplayManager extends JFrame{
	...
	public void initTaskDesc(){
		...
		/* boutton termin� tache ponctuelle */
	...
	/**
	 * Active ou d�sactive les boutons si on souhaite modifier une tache
	 * @param b d�fini le status des bouton (true on modifie la tache / false on ne peut pas modifier la tache
	 */
	...
	public void showMessage(int message) {
		switch(message){
		case 1 :
			JOptionPane.showMessageDialog(new JFrame(),"Vous venez de terminer votre tache celle-ci a �t� transf�r� dans le bilan.");	
			break;
		case 2 :
			JOptionPane.showMessageDialog(new JFrame(),"La date de fin ne peut pas être anterieur à la date du jour celle-ci n'a pas était modifé");
		}
	}
